...
const Qualifications = () => {
  ...
  const tbody = !qualifications.qualifications ? null : qualifications.qualifications.map(qualification =>
    <Link href="/dispatch/staff/[id]/qualifications/[id_qualification]"
          as={`/dispatch/staff/${dispatch.id}/qualifications/${qualification.id}`} key={qualification.id}>
  ...
  return (
    <Layout>
      ...
      <DispatchStaffNavigation id={dispatch.id} page="qualifications" />
      ...
      <Link href="/dispatch/staff/[id]/qualifications/[id_qualification]" as={`/dispatch/staff/${dispatch.id}/qualifications/new`}>
