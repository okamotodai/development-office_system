    ...
    <Layout>
      ...
      <div className="detail">
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center mb-2">
            <div className="w-1/3">
              <label htmlFor="alert" className="form-inline-label">契約終了前アラート期間</label>
            </div>
            <div className="w-2/3">
            <select  name="alert" value={pc.alert || ''} onChange={handleChange} className="form-inline-input">
            　<option value=""></option>
              <option value="62">リースPC（2か月前）</option>
              <option value="14">レンタルPC（2週間前）</option>
            </select>
            <input type="hidden" />
            </div>
          </div>
